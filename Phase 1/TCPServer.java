...
public class TCPServer {
	public static void main(String[] args) throws IOException {
		...
		InetAddress addr = InetAddress.getLocalHost(); // getting its own
														// address (localHost)
		String host = addr.getHostAddress(); // Server machine's IP
		//String routerName = "j263-08.cse1.spsu.edu"; // ServerRouter host name
		String routerName = "10.99.22.210";			    // My IPv4 addres
														// (likely to change, to
														// some machine on the
														// network)
		...
		String address = "10.5.3.196"; // destination IP (Client) (likely to change as well)

		// Communication process (initial sends/receives) reading received data
