...
public class ServerThread implements Runnable {
    ...
    public void run() {
        ...
        /* *****************************************************
         * This code is replaced by the ServerThread constructor
         * ***************************************************** */
        ...
        */
        ...
        try {
            ...
            System.out.println("Couldn't get streams from socket");
            System.out.println("IOException: " + e.getMessage());
        ...
        try {
            ...
            String clientAddress = in.readLine(); // TODO: Do we need to talk to the Router?
            ...
            Socket clientSocket = socket; // TODO: Refactor
